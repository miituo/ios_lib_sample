//
//  CondonacionViewController.swift
//  miituoLib
//
...
class CondonacionViewController: UIViewController {
    ...
    @IBOutlet var kmsdescuento: UILabel!
    ...
    func cargarinformacion(){
        ...
        if odometro != "" {
            ...
            let diferencia = Int(odometro)! - Int(odometroanteriorlast)!
            kms.text = numberFormatter.string(from: NSNumber(value:diferencia))
            ...
            if Int(kilometrosrecorridoslast)! > Int(parametro_tope_kms){
                kilometrosrecorridos.text = numberFormatter.string(from: NSNumber(value: Int(parametro_tope_kms)))
            }else{
            ...
            kmsdescuento.text = "\(kmsdescuentovalor)"
        }
    ...
    func salvarDatos(){
        ...
        let condonacion = kmsdescuento.text!
        
        var arregloFinal : [String:String] = [:]
        arregloFinal["kmsrecorridos"] = kmsre
        arregloFinal["kms"] = kmsrecorridos
        ...
        arregloFinal["cupon"] = ""
        arregloFinal["tope"] = ""
        arregloFinal["condonacion"] = condonacion
...
//************************ lauch polzas********************************//
    func launcpolizas(){
        ...
        //TODO: - hacer dismiss para regresar a polizas
        let back_ticket_polizas = Notification.Name("back_ticket_polizas")
        self.dismiss(animated: false) {
            NotificationCenter.default.post(name: back_ticket_polizas, object: nil)
        }
